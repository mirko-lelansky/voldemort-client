...
MAXES = {
    ...
    "int32": (1 << 31) - 1,
    "int64": (1 << 63) - 1,
    "float32": struct.unpack(">f", b"\x7f\x7f\xff\xff")[0],
    "float64": struct.unpack(">d", b"\x7f\xef\xff\xff\xff\xff\xff\xff")[0],
}
...
MINS = {
    ...
    "int32": -(1 << 31),
    "int64": -(1 << 63),
    "float32": struct.unpack(">f", b"\x00\x00\x00\x01")[0],
    "float64": struct.unpack(">d", b"\x00\x00\x00\x00\x00\x00\x00\x01")[0],
}
